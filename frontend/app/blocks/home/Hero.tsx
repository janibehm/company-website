...
export default function Hero({block}: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden h-[calc(100vh+6rem)] -mt-24 bg-black">
      ...
      <div className="relative z-10 flex flex-col h-screen pt-24">
        <BlockContainer className="pt-4 md:pt-8">
          ...
          <h1 className="text-[clamp(3.5rem,12.5vw,14rem)] font-bold leading-[0.92] tracking-tight uppercase -ml-1 text-white">
            {heading}
          </h1>
        </BlockContainer>

        <BlockContainer className="relative mt-8 sm:mt-12">
