          ...
          <nav className="hidden md:block">
            ...
            >
              ...
              <li className="sm:before:w-[1px] sm:before:bg-white/40 before:block flex sm:gap-4 md:gap-6">
                <Link
                  className="rounded-full flex gap-4 items-center bg-black dark:bg-white hover:bg-blue focus:bg-blue py-2 px-4 justify-center sm:py-3 sm:px-6 text-white dark:text-black dark:hover:text-white transition-colors duration-200"
